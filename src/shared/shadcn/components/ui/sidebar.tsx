      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>SidebarComponent</SheetTitle>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">Toggle SidebarComponent</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label="Toggle SidebarComponent"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="Toggle SidebarComponent"
      className={cn(
